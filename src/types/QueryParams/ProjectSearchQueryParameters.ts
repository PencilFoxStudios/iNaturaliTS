...
/**
 * Defines query parameters for searching projects in iNaturalist.org's API.
 *
 */
export interface ProjectSearchQueryParameters {
    ...
    /**
     * Site ID that applies to featured and noteworthy. Defaults to the site of the authenticated user,
     * or to the main iNaturalist site (https://www.inaturalist.org).
     */
    site_id?: number;
